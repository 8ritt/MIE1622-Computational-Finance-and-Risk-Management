function  [x_optimal, cash_optimal, borrow] = strat_robust_optim(x_init, cash_init, mu, Q, cur_prices, rf, borrow_init)
...
rob_init = w_init' * var_matr * w_init; % return estimation error of initial portfolio
...
cplex_minVar.options.Display = 'off';
